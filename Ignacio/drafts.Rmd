...
I want to look further into the following NAICS:
...
```{r}
#subsetting Manufacturing NAICS
...
x <- cnt$vendorname == "POLYMEDCO CANCER DIAGNOSTIC PRODUCTS LLC"
pol <- cnt[x, c("maj_agency_cat", "dollarsobligated", "contractactiontype", "vendorname", "dunsnumber", "NAICS.name", "productorservicecode")]

unique(pol$productorservicecode)

length(unique(cnt$vendorname))
length(unique(cnt$vendorname))
