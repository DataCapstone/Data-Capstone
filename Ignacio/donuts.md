...
![](donuts_files/figure-markdown_github/unnamed-chunk-6-2.png)
...
![](donuts_files/figure-markdown_github/unnamed-chunk-6-3.png)
...
![](donuts_files/figure-markdown_github/unnamed-chunk-6-4.png)
...
![](donuts_files/figure-markdown_github/unnamed-chunk-6-5.png)
...
#trying the function
krzydonutzz(x= dat, values = "Fed", labels = "recip_cat_type", multiple = "Name", main = "Federal Funding by Recipient type in NY Counties", percent.cex = 3, columns = 2)
```

![](donuts_files/figure-markdown_github/unnamed-chunk-7-1.png)
