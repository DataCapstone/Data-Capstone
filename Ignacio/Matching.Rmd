...
#making rates
#colnames(dem)
dem$pov <- dem$Poverty/dem$Pop
dem$une <- dem$Unemployed/dem$Labor

dem$whi <- dem$White/dem$Pop
dem$bla <- dem$Black/dem$Pop
dem$asi <- dem$Asian/dem$Pop
dem$his <- dem$Hispanic/dem$Pop
...
#Some definitions
* A covariate is a variable that is possibly predictive of the outcome under study. A covariate may be of direct interest or it may be a confounding or interacting variable.
...
#flagging Onondaga with the v Treat
county <- "Broome"
