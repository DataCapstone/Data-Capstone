...
#Function for ordering data into usable form for sankey plots, returns data frame which can be used in sankeyPlot
...
gra16.sankey <- filter(gra16.sankey, fed_funding_amount > 0)
...
#Function for ploting sankey plots
...
df <- filter(gra16.3, county == input$your_county)
